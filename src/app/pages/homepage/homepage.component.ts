...
@Component({
  ...
  standalone: true,
  imports: [GridrowComponent, WelcomeComponent, SpinnerComponent, AddToListComponent, NewSongsComponent, NewAlbumsComponent, BestUsersComponent, RouterModule, PopularListsComponent, RecomendationsComponent],
